      ...
      <el-table :data="roleArr" border style="margin: 10px 0">
        ...
        <el-table-column label="操作" width="300px" align="center">
          <template #="{ row, $index }">
            ...
            <el-button type="primary" size="small" icon="Delete" @click="deleteRole(row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
// api
import { reqAllRole, reqAddOrUpdate, reqAllMenuList, reqSetPermission, reqRemoveRole } from '@/api/acl/role'
// ts type
import type { AllRoleResponseData, RoleData, MenuResponseData, MenuData } from '@/api/acl/role/type'
//store
